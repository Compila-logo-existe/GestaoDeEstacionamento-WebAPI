...
public interface IRepositorioVaga : IRepositorio<Vaga>
{
    ...
    public Task<Vaga?> SelecionarRegistroPorDadosAsync(int vagaNumero, ZonaEstacionamento? zona, Guid estacionamentoId, Guid? tenantId, CancellationToken ct = default);
