...
public class ObterDetalhesVeiculoQueryValidator : AbstractValidator<ObterDetalhesVeiculoQuery>
{
    public ObterDetalhesVeiculoQueryValidator()
    {
        RuleFor(c => c)
    ...
    private static bool CompoeExatamenteUmCaminhoDoRequest(ObterDetalhesVeiculoQuery query)
    {
