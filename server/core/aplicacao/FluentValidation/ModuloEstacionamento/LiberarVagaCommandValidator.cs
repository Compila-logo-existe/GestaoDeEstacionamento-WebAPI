...
public class LiberarVagaCommandValidator : AbstractValidator<LiberarVagaCommand>
{
    public LiberarVagaCommandValidator()
    {
        RuleFor(v => v)
    ...
    private bool CompoeExatamenteUmCaminhoEstacionamentoDoRequest(LiberarVagaCommand command)
    {
    ...
    private bool CompoeExatamenteUmCaminhoVagaDoRequest(LiberarVagaCommand command)
    {
